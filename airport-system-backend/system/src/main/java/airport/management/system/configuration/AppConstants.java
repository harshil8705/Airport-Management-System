package airport.management.system.configuration;
...
public class AppConstants {
    ...
    public static final String SORT_STAFF_BY = "staffId";
    public static final String SORT_PASSENGER_BY = "passengerId";
